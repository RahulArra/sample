...
mongoose.connect(MONGODB_URI, { useNewUrlParser: true, useUnifiedTopology: true }) // [cite: 156]
  .then(() => console.log('✅ MongoDB connected')) // [cite: 157]
  .catch(err => console.error('❌ DB error:', err)); // [cite: 158]
...
// 4. Start Server [cite: 196]
const PORT = process.env.PORT || 4000; // [cite: 197]
app.listen(PORT, () => console.log(`🚀 Server running on http://localhost:${PORT}`)); // [cite: 198]